console.log('createFooterCategoria.js conectado');

// Crear el footer
const footer = document.createElement('footer');
footer.innerHTML = '<ul onclick="showUl(this)"><span><i class="fa-solid fa-chevron-up"></i></span><h3>Sobre nosotros</h3><nav class="navFooter"><li><a href="../footer/aboutus.html">About us</a></li><li><a href="../footer/reseñas.html">Reseñas</a></li><li><a href="../footer/terminosycondiciones.html">Terminos y condiciones</a></li><li><a href="../footer/politicaprivacidad.html">Política de privacidad</a></li><li><a href="../footer/api.html">API</a></li></nav></ul><ul onclick="showUl(this)"><span><i class="fa-solid fa-chevron-up"></i></span><h3>Contacto</h3><nav class="navFooter"><li><a href="../footer/contacto.html">Contacto</a></li><li><a href="../footer/ayuda.html">Ayuda</a></li><li><a href="../footer/devoluciones.html">Devoluciones</a></li></nav></ul><ul onclick="showUl(this)"><span><i class="fa-solid fa-chevron-up"></i></span><h3>Redes Sociales</h3><nav class="navFooter"><li><a href="https://instagram.com"><i class="fa-brands fa-instagram"></i>Instagram</a></li><li><a href="https://x.com"><i class="fa-brands fa-x-twitter"></i>Twitter</a></li><li><a href="https://github.com/vfernandez24"><i class="fa-brands fa-github"></i>Github</a></li><li><a href="https://linkedin.com"><i class="fa-brands fa-linkedin"></i>Linkedin</a></li><li><a href="https://facebook.com"><i class="fa-brands fa-facebook"></i>Facebook</a></li><li><a href="https://youtube.com"><i class="fa-brands fa-youtube"></i>Youtube</a></li><li><a href="https://tiktok.com"><i class="fa-brands fa-tiktok"></i>Tik Tok</a></li></nav></ul>';
